...
typedef struct enginefuncs_s {
    ...
    int         (__cdecl*pfnPrecacheSound)        (const char* s);
    void        (__cdecl*pfnSetModel)            (struct edict_t *e, const char *m);
    int         (__cdecl*pfnModelIndex)        (const char *m);
    int         (__cdecl*pfnModelFrames)        (int modelIndex);
    void        (__cdecl*pfnSetSize)            (struct edict_t *e, const float *rgflMin, const float *rgflMax);
    void        (__cdecl*pfnChangeLevel)        (const char* s1, const char* s2);
    void        (__cdecl*pfnGetSpawnParms)        (struct edict_t *ent);
    void        (__cdecl*pfnSaveSpawnParms)        (struct edict_t *ent);
    float       (__cdecl*pfnVecToYaw)            (const float *rgflVector);
    void        (__cdecl*pfnVecToAngles)        (const float *rgflVectorIn, float *rgflVectorOut);
    void        (__cdecl*pfnMoveToOrigin)        (struct edict_t *ent, const float *pflGoal, float dist, int iMoveType);
    void        (__cdecl*pfnChangeYaw)            (struct edict_t* ent);
    void        (__cdecl*pfnChangePitch)        (struct edict_t* ent);
    ...
    void        (__cdecl*pfnServerCommand)        (const char* str);
    void        (__cdecl*pfnServerExecute)        (void); // 41
    void        (__cdecl*pfnClientCommand)        (struct edict_t* pEdict, const char* szFmt, ...);
    void        (*pfnParticleEffect)        (const float *org, const float *dir, float color, float count);
    void        (__cdecl*pfnLightStyle)        (int style, const char* val);
    int         (*pfnDecalIndex)        (const char *name);
    int         (*pfnPointContents)        (const float *rgflVector); // 46
    void        (__cdecl*pfnMessageBegin)        (int msg_dest, int msg_type, const float *pOrigin, struct edict_t *ed);
    void        (__cdecl*pfnMessageEnd)        (void);
    void        (__cdecl*WRITE_BYTE)            (int iValue);
    void        (__cdecl*WRITE_CHAR)            (int iValue);
    void        (__cdecl*WRITE_SHORT)        (int iValue);
    void        (__cdecl*PF_WriteLong_I)            (int iValue);
    void        (__cdecl*PF_WriteFloat_I)            (int iValue);
    void        (__cdecl*PF_WriteAngle_I)        (float flValue);
    void        (__cdecl*PF_WriteCoord_I)        (float flValue);
    void        (__cdecl*PF_WriteString_I)        (const char *sz);
    void        (__cdecl*PF_WriteEntity_I)        (int iValue);
    ...
    int         (__cdecl*pfnIndexOfEdict)        (const struct edict_t *pEdict);
    ...
    struct CWeaponMgr* (*GetWeaponManager)();
    void* (*GetFromUnkFunc)();
    void* (*UnkFunc)();
...
typedef struct {
    ...
    void        (__cdecl *pfnUse)            (struct edict_t *pentUsed, struct edict_t *pentOther);
    ...
    void        (__cdecl *pfnSaveWriteFields)    (struct SAVERESTOREDATA *, const char *, void *, struct TYPEDESCRIPTION *, int);
    void        (__cdecl *pfnSaveReadFields)    (struct SAVERESTOREDATA *, const char *, void *, struct TYPEDESCRIPTION *, int);
    void        (__cdecl *pfnSaveGlobalState)        (struct SAVERESTOREDATA *);
    void        (__cdecl *pfnRestoreGlobalState)    (struct SAVERESTOREDATA *);
